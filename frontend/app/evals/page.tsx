...
const KPICard = ({
  ...
  <Card className="p-6 bg-card border-[var(--color-border)] shadow-[var(--shadow-elevation-1)]">
    ...
    <div className="flex items-center justify-between text-sm">
      ...
      {vsBaseline && (
        <span className="text-muted-foreground">{vsBaseline}</span>
      )}
    </div>
  </Card>
)
      ...
      <div className="container mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1">
            <Card className="p-6 bg-card border-[var(--color-border)] shadow-[var(--shadow-elevation-1)] h-full">
                      ...
                      <RechartsTooltip
                        content={({ active, payload }) => {
                          if (active && payload && payload.length) {
                            ...
                            return (
                              <div className="bg-card border border-[var(--color-border)] rounded-lg p-3 shadow-lg">
